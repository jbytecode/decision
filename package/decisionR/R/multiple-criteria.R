...
#' @name ahp.consistency
#' @title Criteria(or Alternative)-Consistency for AHP
#' @description This function tests whether a criteria/Alternative comparison matrix is consistent or not. 
#' The function also returns a priority vector for AHP based decision making.
#' @param CriteriaComparisonMatrix an nxn comparison matrix. The comparison matrix has integer element ranging 
#' between 1 and 9. If an element in row i and column j has a value of a then the element in row j and column i 
#' have the value of 1/a.
#' @return A list of result of AHP consistency test procedure.
#' @references Celikbilek Yakup, Cok Kriterli Karar Verme Yontemleri, Aciklamali ve Karsilastirmali
#' Saglik Bilimleri Uygulamalari ile. Editor: Muhlis Ozdemir, Nobel Kitabevi, Ankara, 2018
#' @author Mehmet Hakan Satman - mhsatman@istanbul.edu.tr
#' @examples
